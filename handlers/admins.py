...
async def update_admin(client, message):
    ...
    await client.send_message(message.chat.id, "✅ Bot **reload berhasil!**\n\n• **Admin list** Telah di **update.**")
...
async def stop(_, message: Message):
    ...
    if chat_id not in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_text("✅ The **Userbot terputus dari obrolam suara**")
...
async def skip(_, message: Message):
    ...
    if not qeue:
        return
    await message.reply_text(f"⏭️ **__Kamu sudah melewati untuk lagu selanjutnya__**")
